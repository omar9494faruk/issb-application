...
$conn = mysqli_connect("localhost", "searchli_mainDevAlpha", "AkashBhoraTara@", "searchli_pAFphy");
$query = mysqli_query($conn, "SELECT COUNT(*) AS table_count FROM information_schema.tables WHERE table_schema ='searchli_pAFphy' ");
$Set = mysqli_fetch_assoc($query);

$tableShow = "SELECT table_name, table_rows FROM information_schema.tables WHERE table_schema = 'searchli_pAFphy'";
...
<head>
    ...
    <title>AF Prelims Physics Update</title>
