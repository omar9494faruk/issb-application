...
$conn = mysqli_connect("localhost", "searchli_mainDevAlpha", "AkashBhoraTara@", "searchli_pAFeng");
$query = mysqli_query($conn, "SELECT COUNT(*) AS table_count FROM information_schema.tables WHERE table_schema ='searchli_pAFeng' ");
$Set = mysqli_fetch_assoc($query);

$tableShow = "SELECT table_name, table_rows FROM information_schema.tables WHERE table_schema = 'searchli_pAFeng'";
...
<head>
    ...
    <title>AF Prelims English Update</title>
