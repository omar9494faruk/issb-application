...
$query = mysqli_query($conn, "SELECT COUNT(*) AS table_count FROM information_schema.tables WHERE table_schema ='searchli_pAFiq' ");
$Set = mysqli_fetch_assoc($query);

$tableShow = "SELECT table_name, table_rows FROM information_schema.tables WHERE table_schema = 'searchli_pAFiq'";
