...
$stmt1 = $conn-> prepare("SELECT banSent FROM bangla ORDER BY RAND() LIMIT 25");
$stmt1 ->execute();
        ...
        function startTimer() {
            ...
            timer = setInterval(function() {
                ...
                if (timeLimit <= 0) {
                    ...
                    window.location.href = '../../wish.php'; // Change 'result.php' to your destination page
                } else {
                    timeLimit--;
                }
            }, 1000);
